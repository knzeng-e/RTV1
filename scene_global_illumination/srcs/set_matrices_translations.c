...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   set_matrices_translations.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: knzeng-e <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/10 22:28:39 by knzeng-e          #+#    #+#             */
/*   Updated: 2018/04/10 22:28:41 by knzeng-e         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_translation(t_transform *transforms, double dx, double dy, double dz)
{
	...
	transforms->translation.mat[0][2] = 0;//sin(angle);
	...
	transforms->translation.mat[2][0] = 0;//-sin(angle);
	transforms->translation.mat[2][1] = 0;
	transforms->translation.mat[2][2] = 1;//cos(angle);
